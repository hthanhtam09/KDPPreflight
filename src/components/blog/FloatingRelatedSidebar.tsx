...
export function FloatingRelatedSidebar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      style={floatingStyle}
      className="space-y-8 lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto lg:pr-1 [scrollbar-gutter:stable]"
    >
      {children}
    </div>
  );
