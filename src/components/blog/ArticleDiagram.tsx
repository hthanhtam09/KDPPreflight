...
function LowContentVsRegular() {
  const Card = ({ x, title, examples, isbn, tone, color }: { x: number; title: string; examples: string; isbn: string; tone: string; color: string }) => (
    <g>
...
function LowContentClassificationFlow() {
  const steps = [
...
function LowContentPrintRiskMap() {
  const risks = [
...
function CheapVsPremiumLayout() {
  const Cover = ({ x, premium }: { x: number; premium: boolean }) => (
    <g>
...
function ProofCopyIterationFlow() {
  const steps = [
...
function DarkColoringDigitalVsPrint() {
  return (
    <g>
...
function MatteVsGlossyColoringContrast() {
  const Panel = ({ x, title, strong }: { x: number; title: string; strong: boolean }) => (
    <g>
  ...
  return (
    <g>
      ...
      <Panel x={118} title="matte: softer contrast" strong={false} />
      <Panel x={438} title="glossier: more pop" strong />
...
function PureBlackVsDarkGray() {
  const Page = ({ x, pure }: { x: number; pure: boolean }) => (
    <g>
...
function MuddyVsCleanColoringPages() {
  const Page = ({ x, clean }: { x: number; clean: boolean }) => (
    <g>
