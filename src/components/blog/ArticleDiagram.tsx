...
function DPI72vs300() {
  return (
    <g>
      ...
      <text x={184} y={360} fill="var(--danger)" fontSize="19" fontWeight="900" textAnchor="middle">72 pixels / inch</text>
      <MutedLabel x={136} y={390}>large blocks — blurry print</MutedLabel>
      ...
      <text x={522} y={360} fill="var(--success)" fontSize="19" fontWeight="900" textAnchor="middle">300 pixels / inch</text>
      <MutedLabel x={472} y={390}>fine detail — sharp print</MutedLabel>
    </g>
  );
}
